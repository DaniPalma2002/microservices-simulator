...
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.events.subscribe.QuestionSubscribesDeleteTopic;
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.events.subscribe.QuestionSubscribesUpdateTopic;
...
public abstract class Question extends Aggregate {
    ...
    private pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.QuestionCourse questionCourse;
    ...
    public Question(Integer aggregateId, pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.QuestionCourse questionCourse, pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.QuestionDto questionDto, List<QuestionTopic> questionTopics) {
        super(aggregateId);
    ...
    public Question(Question other) {
        ...
        setQuestionCourse(new pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.QuestionCourse(other.getQuestionCourse()));
    ...
    public pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.QuestionCourse getQuestionCourse() {
