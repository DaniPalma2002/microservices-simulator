...
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant;
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.events.subscribe.*;
...
public abstract class Tournament extends Aggregate {
    ...
    private Set<pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant> tournamentParticipants = new HashSet<>();
    /*
    COURSE_EXECUTION_IS_FINAL
    ...
    public Tournament(Tournament other) {
        ...
        setTournamentParticipants(other.getTournamentParticipants().stream().map(pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant::new).collect(Collectors.toSet()));
    }
    ...
    private void interInvariantQuizAnswersExist(Set<EventSubscription> eventSubscriptions) {
        for (pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant tournamentParticipant: this.tournamentParticipants) {
    ...
    public boolean invariantUniqueParticipant() {
        return this.tournamentParticipants.size()
                ...
                .map(pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant::getParticipantAggregateId)
                .distinct()
                .count();
    }
    ...
    public boolean invariantParticipantsEnrolledBeforeStarTime() {
        for (pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant p : this.tournamentParticipants) {
    ...
    public boolean invariantAnswerBeforeStart() {
        if (DateHandler.now().isBefore(this.startTime)) {
            for (pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant t : this.tournamentParticipants) {
    ...
    public Set<pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant> getTournamentParticipants() {
        return tournamentParticipants;
    }

    public void setTournamentParticipants(Set<pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant> tournamentParticipants) {
        /*
        IS_CANCELED
		    this.canceled => final this.startTime && final this.endTime && final this.numberOfQuestions && final this.tournamentTopics && final this.participants && p: this.participant | final p.answer
         */
    ...
    public void addParticipant(pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant participant) {
    ...
    public pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant findParticipant(Integer userAggregateId) {
