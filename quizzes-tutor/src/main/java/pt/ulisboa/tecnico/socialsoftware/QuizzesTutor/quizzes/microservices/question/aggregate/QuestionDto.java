...
public class QuestionDto implements Serializable {
    ...
    private List<pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.OptionDto> optionDtos;
   ...
   public QuestionDto(Question question) {
       ...
       setOptionDtos(question.getOptions().stream()
               .map(pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.OptionDto::new)
    ...
    public List<pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.aggregate.OptionDto> getOptionDtos() {
        return optionDtos;
    }
