...
public class TournamentParticipantQuizAnswer {
    ...
    @OneToOne
    private pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant tournamentParticipant;
    ...
    public pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.aggregate.TournamentParticipant getTournamentParticipant() {
