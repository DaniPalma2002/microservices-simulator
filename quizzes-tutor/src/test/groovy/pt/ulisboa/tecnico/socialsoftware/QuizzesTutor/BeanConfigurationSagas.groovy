package pt.ulisboa.tecnico.socialsoftware.QuizzesTutor
...
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.coordination.eventProcessing.*
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.coordination.functionalities.*
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.answer.events.handling.QuizAnswerEventHandling
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.answer.service.QuizAnswerService
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.course.service.CourseService
...
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.execution.events.handling.CourseExecutionEventHandling
...
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.events.handling.QuestionEventHandling
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.question.service.QuestionService
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.quiz.aggregate.QuizRepository
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.quiz.events.handling.QuizEventHandling
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.quiz.service.QuizService
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.topic.aggregate.TopicRepository
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.topic.service.TopicService
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.events.handling.TournamentEventHandling
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.tournament.service.TournamentService
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.user.aggregate.UserRepository
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.microservices.user.service.UserService
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.sagas.aggregates.factories.*
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.sagas.aggregates.repositories.CourseCustomRepositorySagas
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.sagas.aggregates.repositories.CourseExecutionCustomRepositorySagas
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.sagas.aggregates.repositories.QuizAnswerCustomRepositorySagas
import pt.ulisboa.tecnico.socialsoftware.QuizzesTutor.quizzes.sagas.aggregates.repositories.TournamentCustomRepositorySagas
